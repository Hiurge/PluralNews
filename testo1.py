...
keywords = None # User input
keywords = "Morawiecki davos" # Test
keywords = "+".join(keywords.split(" "))

# TO DO:
# 1. scrap text from one target news
# 2. clean text
# 3. option: check how to increase news number in 1 search by google url
# 4. ?
...
# We store search_info for each search type here. 
# Data is stored in tvn_search[n] where 
# n = single news number 
# in given search (for now it's 10 positions):
...
def extract_text_from_one_news():
	pass

	return one_news_text
# extract_text_from_one_news()

# Clean news text
def clean_text(one_news_text):
	pass

	return one_news_text_clean
# clean_text(one_news_text)
...
print("First tvn search news example for " + keywords +" tvn.pl:")
print()
print("Title: ",tvn_search[0][0])
print("Source: ",tvn_search[0][1])
print("Date: ",tvn_search[0][2])
print("Summary: ",tvn_search[0][3])
print("Link: ",tvn_search[0][4])

#
#
# First tvn search example for Morawiecki+davos tvn.pl:
# Title:  Premier o sporze z Unią. "Musimy zmienić sądownictwo dużo 
# Source:  Premier o sporze z Unią. "Musimy zmienić sądownictwo dużo 
# Summary:  Premier o sporze z Unią. "Musimy zmienić sądownictwo dużo 
# Link:  Premier o sporze z Unią. "Musimy zmienić sądownictwo dużo 
#
#
################################333
####
